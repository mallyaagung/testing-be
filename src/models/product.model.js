...
const productModel = {
  ...
  countAll: (
    ...
    new Promise((resolve, reject) => {
      let sql =
        "SELECT count(*) FROM products INNER JOIN airlines ON products.airline_id = airlines.id WHERE products.stock >= 1";
